...
func sensitiveConfigKey(key string) bool {
	...
	if normalized == "pwd" || normalized == "passwd" || normalized == "authorization" || normalized == "credential" || normalized == "credentials" || normalized == "pin" || normalized == "pairingcode" || normalized == "setupuri" {
		return true
	}
