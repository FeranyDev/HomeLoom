...
var modelContracts = map[Type]ModelContract{
	...
	TypeAirConditioner: {DeviceType: TypeAirConditioner, Name: "空调", Version: 3, Parameters: append([]ModelParameter{
		...
		optionalEnum("air-conditioner", "fan-speed", "风速档位", true, "auto", "low", "medium_low", "medium", "medium_high", "high", "turbo", "quiet"),
		...
		optionalEnum("air-conditioner", "vertical-swing-mode", "上下扫风位置", true, "default", "swing_full", "fixed_upmost", "fixed_middle_up", "fixed_middle", "fixed_middle_low", "fixed_lowest", "swing_downmost", "swing_middle_low", "swing_middle", "swing_middle_up", "swing_upmost"),
		optionalEnum("air-conditioner", "horizontal-swing-mode", "左右扫风位置", true, "default", "swing_full", "fixed_leftmost", "fixed_middle_left", "fixed_middle", "fixed_middle_right", "fixed_rightmost"),
		...
		optional("air-conditioner", "eight-degree-heat", "8°C 防冻制热", ValueTypeBool, "", true),
		optional("air-conditioner", "sleep-mode", "睡眠模式", ValueTypeBool, "", true),
		optional("air-conditioner", "sleep", "睡眠", ValueTypeBool, "", true),
		optional("air-conditioner", "eco-mode", "节能模式", ValueTypeBool, "", true),
		optional("air-conditioner", "power-save", "省电模式", ValueTypeBool, "", true),
		optional("air-conditioner", "x-fan", "X-Fan", ValueTypeBool, "", true),
		optional("air-conditioner", "health", "健康模式", ValueTypeBool, "", true),
		optional("air-conditioner", "air", "新风模式", ValueTypeBool, "", true),
		optional("air-conditioner", "display-enabled", "面板显示", ValueTypeBool, "", true),
		optional("air-conditioner", "anti-direct-blow", "防直吹", ValueTypeBool, "", true),
		optional("air-conditioner", "light-sensor", "光线传感器", ValueTypeBool, "", true),
