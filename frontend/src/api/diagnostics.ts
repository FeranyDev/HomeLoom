...
export const runtimeLogRecoveryLimit = 2000
export const listRuntimeLogs = (after = 0, signal?: AbortSignal) => requestData<SubprocessLogEntry[]>(`/api/v1/system/runtime-logs?after=${after}&limit=${runtimeLogRecoveryLimit}`, { signal })
