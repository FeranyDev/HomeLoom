...
describe('ProviderCard simulation', () => {
  it('sends ephemeral availability and temperature changes', async () => {
    ...
    render(<ProviderCard provider={provider} devices={[{ id: 'temp-1', providerId: provider.id, name: '温度', type: 'temperature-sensor', online: true, state: { temperature: 22 }, lastUpdateAt: '' }]} onEdit={() => {}} onDelete={() => {}} onSimulate={onSimulate} />)
