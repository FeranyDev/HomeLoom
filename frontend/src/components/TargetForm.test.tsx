...
describe('TargetForm', () => {
  ...
  it('shows server field errors and refills an existing target', async () => {
		const target: Target = { id: 'apple-main', type: 'apple-hap', name: 'Main Bridge', enabled: true, status: 'running', address: ':51826', setupId: 'HLM1', pairingCode: '001-02-003', deviceIds: ['switch-1'], devices: [] }
